...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-4 sm:p-6 md:p-8">
  <div className="max-w-2xl mx-auto space-y-8">
    <header className="text-center space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="bg-amber-100 dark:bg-amber-900/30 p-4 rounded-lg text-amber-800 dark:text-amber-200 text-sm">
          ℹ️ Quick, simple text sharing - perfect for notes and temporary messages. Use a unique key!
        </div>
      </div>
    </header>
